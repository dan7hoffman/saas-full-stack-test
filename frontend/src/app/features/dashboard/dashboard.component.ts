    ...
    <div class="dashboard">
      ...
      <div class="quick-actions-section">
        ...
        <div class="actions-grid">
          ...
          <a routerLink="/finance/dashboard" class="action-card">
            <div class="action-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="action-content">
              ...
              <p>View your financial progress</p>
            </div>
          </a>

          <a routerLink="/finance/balance-entry" class="action-card">
            <div class="action-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="action-content">
              <h3>Enter Balances</h3>
              <p>Record quarterly balance data</p>
            </div>
          </a>

          <a routerLink="/invite/manage" class="action-card">
            <div class="action-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="action-content">
              ...
              <p>Send invitations to join your organization</p>
            </div>
          </a>
